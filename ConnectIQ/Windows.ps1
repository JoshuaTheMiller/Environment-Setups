...
# Eventually I want to turn this into a choco package itself to simplify this whole install file...
# | Dependencies
# |--> jdk8
# |--> javaruntime
...
$sdkUrl = "https://developer.garmin.com/downloads/connect-iq/sdks/connectiq-sdk-win-3.0.6-2018-11-27-33ec0d6.zip";
...
$finalDestination = "C:\Program Files\ConnectIQ-SDK";
Copy-Item -Path "$unzippedFolderPath" -Destination "$finalDestination" -Force -Recurse;

AppendToPath "$finalDestination\bin\";
